...
import com.github.radlance.login.R
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp), modifier = modifier) {
        OutlinedTextField(
            ...
            label = {
                ...
                ) stringResource(com.github.radlance.common.R.string.name) else fieldsUiState.nameErrorMessage
        ...
        OutlinedTextField(
            ...
            label = {
                ...
                ) stringResource(com.github.radlance.common.R.string.email) else {
            ...
            placeholder = {
                Text(text = stringResource(com.github.radlance.common.R.string.enter_your_email))
            },
        ...
        OutlinedTextField(
            ...
            label = {
                ...
                ) stringResource(com.github.radlance.common.R.string.password) else {
            ...
            placeholder = {
                Text(text = stringResource(com.github.radlance.common.R.string.enter_your_password))
            },
